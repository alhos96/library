...
import { getSomething, blockInvalidChar, methods } from "../../helpers";
        ...
        <Box className="Add-book">
          ...
          <Formik
            ...
            onSubmit={(values) => {
              ...
              axios
                .post(`http://localhost:5000/api${url}`, newBook, {
          ...
          >
            {({ values }) => (
              <Form encType="multipart/form-data">
                ...
                <Field onKeyDown={blockInvalidChar} name="price" type="number" className="text-input" />
                <ErrorMessage className="error" name="price" component="p" />

                <label htmlFor="pages">Pages:</label>
                <Field onKeyDown={blockInvalidChar} name="pages" type="number" className="text-input" />
                  ...
                  render={(arrayHelpers) => (
                    <div className="field-array-wrapp">
                      ...
                      {values.authors && values.authors.length > 0 ? (
                        ...
                        <Typography>Add authors...</Typography>
                      )}
                    </div>
                  )}
                  type="select"
